...
- [6. 拡張と改変の方向性](#6-拡張と改変の方向性)
  - [6.1. 問題](#61-問題)
  - [6.2. 必ずいつかやりたいこと](#62-必ずいつかやりたいこと)
...
## 6.1. 問題
- 失業時の要求賃金率の減少率を上げると、企業の黒字が減るのはなぜ？
- 名目政府支出増加率が高いと、労働稼働率が1よりずいぶん大きくなる
  - 要求賃金率上昇率が低く、失業率が十分に低いとその様になる。
  - 労働稼働率が一定以上になることができず、足りない労働力需要分は生産が減るように仕様変更を検討する

## 6.2. 今後必ずしたいこと
- 消費が平均の何倍かで頭打ちにする。現状、可処分所得と金融資産保有額で決めているが、資産家や高収入の家計が消費性向が低いことを記述したい
- 労働稼働率が一定以上になることができず、足りない労働力需要分は生産が減るように仕様変更を検討する
- プロットの工夫
  - 企業規模の分布
    - 従業員数
