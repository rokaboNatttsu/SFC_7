...
1. 現実的な税率を採用したのに、$c$ が $g$ に対して小さすぎる。政府から民間への支出が経済学的な意味の政府支出しか無いことが原因と思われる。政府から家計へ、GDP比で20〜25％くらいの所得移転を追加する。生活保護を意識して失業時の給付と、年金その他を意識して全ての家計へ給付を検討する
2. $r_{Lf}=(1-\lambda_{rLf})r_{Lf-1}+\lambda_{rLf}(1+\epsilon_3+\frac{\Delta Z^n}{\sum_o L_{f-1}^{o,n}})$ で企業向けの適応的な金利を導入することを検討
3. 起業する企業の資本が何もないところから出てくるのではなく、既存企業の生産した資本を買う形式にする
4. jlファイルの変更をmain.mdに反映させる作業
