...
1. $t \neq 150$ の前後でNaNになる問題
2. v_average のプロットが途切れる問題
3. $r_{Lf}=(1-\lambda_{rLf})r_{Lf-1}+\lambda_{rLf}(1+\epsilon_3+\frac{\Delta Z^n}{\sum_o L_{f-1}^{o,n}})$ で企業向けの適応的な金利を導入することを検討
4. 起業する企業の資本が何もないところから出てくるのではなく、既存企業の生産した資本を買う形式にする
5. jlファイルの変更をmain.mdに反映させる作業
