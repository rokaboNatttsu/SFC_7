...
| 企業株式純発行 |                   $0$                    |                                   |  $+\sum_o p_{e-1}^o \Delta e^o$  | $-\sum_n\sum_o p_{e-1}^o \Delta e_b^{o,n}$ |                      |   $0$   |
| 銀行株式純発行 | $-\sum_l\sum_n p_{f-1}^n \Delta f^{n,l}$ |                                   |                                  |                                            |                      |   $0$   |
...
| 銀行株式保有量増減 | $-\sum_n p_{f-1}^n \Delta f^{n,l}$ |                                      |                             |                            |                                      |                      |
